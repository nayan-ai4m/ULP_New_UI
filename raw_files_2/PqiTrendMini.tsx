  ...
  return (
    <div className="panel p-4">
      <div className="flex items-center justify-between mb-1">
        <h3 className="text-sm font-semibold">PQI Trend</h3>
        <span className="text-[10px] font-mono text-foreground-dim">Last {series.length}</span>
      </div>
      <div className="flex items-center gap-3 text-[10px] uppercase tracking-wider mb-1.5">
