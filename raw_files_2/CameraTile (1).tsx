...
export function CameraTile({ name }: { name: string }) {
  return (
    <div className="panel-raised relative overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 min-h-[160px] bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-2 right-2 font-mono text-[10px] text-foreground-muted">
            640×480 · 30fps
          </div>
          {/* crosshair */}
          <div className="absolute inset-0 grid place-items-center">
            <div className="h-px w-6 bg-foreground/30" />
            <div className="absolute w-px h-6 bg-foreground/30" />
          </div>
        </div>
      </div>
    </div>
