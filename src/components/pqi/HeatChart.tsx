    ...
    <div className="panel p-4 flex flex-col">
      <div className="mb-2">
        ...
        <p className="text-[13px] text-foreground-muted mt-0.5">
          T_inner {series[series.length - 1]?.tInner.toFixed(1)}°C · SIT
          threshold {sitThreshold}°C · T_jaw {tJawCurrent}°C
        </p>
      </div>
