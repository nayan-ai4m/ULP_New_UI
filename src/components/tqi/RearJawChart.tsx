...
export function RearJawChart({ series, setpoint }: Props) {
  ...
  return (
    <div className="panel p-4 h-full flex flex-col">
      <div className="mb-2">
        <h3 className="text-[15px] font-semibold">Rear Jaw — Temperature</h3>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={series} margin={{ top: 32, right: 90, bottom: 28, left: 4 }}>
            ...
            <ReferenceLine
              ...
              strokeDasharray="6 4"
              label={{ value: `SP ${setpoint}°C`, fill: "hsl(270 70% 65%)", fontSize: 10, position: "insideTopRight" }}
            />
            <ReferenceLine
              y={setpoint + 3}
